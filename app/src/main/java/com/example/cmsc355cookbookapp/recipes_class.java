...
public class recipes_class {
    ...
    public recipes_class(int id, String recipe, String r_ing1, String r_ing2, String r_ing3, int r_ing1_amt, int r_ing2_amt, int r_ing3_amt, String r_ing1_amtType, String r_ing2_amtType, String r_ing3_amtType) {
        this.id = id;
        this.recipe = recipe;
        this.r_ing1 = r_ing1;
        this.r_ing2 = r_ing2;
